...
export function NewServiceModal({ open, onClose, onCreated }: NewServiceModalProps) {
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-50 flex items-center justify-center bg-[#332925]/40 p-4 backdrop-blur-[3px]"
      onMouseDown={(event) => {
    ...
    >
      <div className="relative flex max-h-[88vh] w-full max-w-md flex-col overflow-hidden rounded-[22px] border border-[#eee4df] bg-white shadow-[0_25px_70px_-25px_rgba(40,29,25,.45)]">
        {/* Header — compacto, dentro do fluxo, sem hero cheio de blobs */}
