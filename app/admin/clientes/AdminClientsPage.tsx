  ...
  useEffect(() => {
    ...
    async function loadMonthlyAppointments() {
      try {
        ...
        if (mounted) setMonthlyAppointments(count);
      } catch (error) {
    ...
    <AdminShell>
      <main className="min-h-screen bg-[#faf6f3] text-[#6b5850]">
        <div className="pointer-events-none fixed inset-0 overflow-hidden">
          {/*<div className="absolute -right-40 -top-40 h-96 w-96 rounded-full bg-[#f0e0d7]/45" />*/}
          {/*<div className="absolute -left-40 top-[38%] h-96 w-96 rounded-full bg-[#f4ede6]/60 blur-xl" />*/}
        ...
        <div className="relative mx-auto max-w-[1500px] px-5 py-7 lg:px-8 lg:py-9">
          ...
          <div className="mt-8">
            <ClientStats
              ...
              debtClients={debtClients.length}
            />
          </div>
